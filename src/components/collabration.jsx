    ...
    <Section crossess>
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          ...
          <ul className="max-w-[22rem] md:mb-14 mb-10">
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-6">
          ...
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 -translate-x-1/2 rounded-full scale-75 md:100">
